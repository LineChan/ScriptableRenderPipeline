...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
    ...
    public class LightweightAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent depthPrepassContext = new GUIContent("Depth prepass", "Force a depth prepass before rendering the opaque geometry");
        ...
        private SerializedProperty m_DepthPrepass;
        ...
        void OnEnable()
        {
            ...
            m_DepthPrepass = serializedObject.FindProperty("m_ForceDepthPrepass");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_DepthPrepass, Styles.depthPrepassContext);
